...
OBJECTS = build/main.o build/soundbank.out build/collisions.o build/debug.o build/enemies.o build/game.o build/lang.o build/menu.o build/scroll.o build/sram.o build/worldmap.o
SOURCES = src/main.c
ELFS = build/main.elf
